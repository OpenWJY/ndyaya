package com.ndyaya.module.bpm.service.task;
...
import com.ndyaya.framework.common.util.date.DateUtils;
import com.ndyaya.framework.common.util.json.JsonUtils;
import com.ndyaya.framework.common.util.object.ObjectUtils;
import com.ndyaya.framework.common.util.object.PageUtils;
import com.ndyaya.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.ndyaya.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.ndyaya.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.ndyaya.module.bpm.controller.admin.task.vo.instance.*;
import com.ndyaya.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.ndyaya.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.ndyaya.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.ndyaya.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.ndyaya.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.ndyaya.module.bpm.enums.ErrorCodeConstants;
import com.ndyaya.module.bpm.enums.definition.BpmModelTypeEnum;
import com.ndyaya.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.ndyaya.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.ndyaya.module.bpm.enums.task.BpmReasonEnum;
import com.ndyaya.module.bpm.enums.task.BpmTaskStatusEnum;
import com.ndyaya.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.ndyaya.module.bpm.framework.flowable.core.candidate.strategy.dept.BpmTaskCandidateStartUserSelectStrategy;
import com.ndyaya.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.ndyaya.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.ndyaya.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.ndyaya.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.ndyaya.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.ndyaya.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.ndyaya.module.bpm.service.definition.BpmProcessDefinitionService;
import com.ndyaya.module.bpm.service.message.BpmMessageService;
...
import static com.ndyaya.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.ndyaya.module.bpm.enums.ErrorCodeConstants.*;
import static com.ndyaya.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
