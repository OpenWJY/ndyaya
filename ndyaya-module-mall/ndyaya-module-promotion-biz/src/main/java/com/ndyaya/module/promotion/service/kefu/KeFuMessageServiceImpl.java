package com.ndyaya.module.promotion.service.kefu;
...
import com.ndyaya.module.infra.api.websocket.WebSocketSenderApi;
import com.ndyaya.module.member.api.user.MemberUserApi;
import com.ndyaya.module.promotion.controller.admin.kefu.vo.message.KeFuMessageListReqVO;
import com.ndyaya.module.promotion.controller.admin.kefu.vo.message.KeFuMessageSendReqVO;
...
import com.ndyaya.module.promotion.dal.dataobject.kefu.KeFuConversationDO;
import com.ndyaya.module.promotion.dal.dataobject.kefu.KeFuMessageDO;
import com.ndyaya.module.promotion.dal.mysql.kefu.KeFuMessageMapper;
...
import static com.ndyaya.module.promotion.enums.ErrorCodeConstants.KEFU_CONVERSATION_NOT_EXISTS;
import static com.ndyaya.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_ADMIN_READ;
import static com.ndyaya.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_TYPE;
