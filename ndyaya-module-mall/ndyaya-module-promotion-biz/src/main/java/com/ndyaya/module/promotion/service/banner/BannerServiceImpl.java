package com.ndyaya.module.promotion.service.banner;

import com.ndyaya.framework.common.pojo.PageResult;
import com.ndyaya.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import com.ndyaya.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import com.ndyaya.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import com.ndyaya.module.promotion.convert.banner.BannerConvert;
import com.ndyaya.module.promotion.dal.dataobject.banner.BannerDO;
import com.ndyaya.module.promotion.dal.mysql.banner.BannerMapper;
...
import static com.ndyaya.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
