...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ndyaya.boot";
    private static final String ARTIFACT_ID = "ndyaya";
    private static final String PACKAGE_NAME = "com.ndyaya";
    private static final String TITLE = "NDYAYA管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ndyaya.boot";
        String artifactIdNew = "ndyaya";
        String packageNameNew = "com.ndyaya";
        String titleNew = "NDYAYA管理系统";
