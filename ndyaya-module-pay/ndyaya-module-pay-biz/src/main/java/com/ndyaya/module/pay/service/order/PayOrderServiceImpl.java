...
import com.ndyaya.framework.common.util.date.LocalDateTimeUtils;
...
import com.ndyaya.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.ndyaya.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import com.ndyaya.framework.tenant.core.util.TenantUtils;
...
import com.ndyaya.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/ndyaya-cloud/issues/I8SM9H 场景
