...
import com.ndyaya.framework.tracer.core.aop.BizTraceAspect;
import com.ndyaya.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ndyaya.tracer", value = "enable", matchIfMissing = true)
public class NdyayaTracerAutoConfiguration {
