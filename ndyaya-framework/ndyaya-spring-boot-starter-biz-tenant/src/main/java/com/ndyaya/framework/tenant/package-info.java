 ...
 *      1）Spring Async：
 *          {@link com.ndyaya.framework.quartz.config.NdyayaAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 NdyayaSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.ndyaya.framework.tenant;
