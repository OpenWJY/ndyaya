package com.ndyaya.module.infra.service.logger;
...
import com.ndyaya.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.ndyaya.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.ndyaya.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.ndyaya.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.ndyaya.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.ndyaya.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ndyaya-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("ndyaya-test");
