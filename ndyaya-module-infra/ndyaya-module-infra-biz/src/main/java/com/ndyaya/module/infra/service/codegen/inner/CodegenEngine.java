package com.ndyaya.module.infra.service.codegen.inner;
...
import com.ndyaya.framework.apilog.core.enums.OperateTypeEnum;
...
import com.ndyaya.framework.excel.core.annotations.DictFormat;
import com.ndyaya.framework.excel.core.convert.DictConvert;
import com.ndyaya.framework.excel.core.util.ExcelUtils;
import com.ndyaya.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ndyaya-module-${table.moduleName}/" + // 顶级模块
                "ndyaya-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ndyaya-module-${table.moduleName}/" + // 顶级模块
                "ndyaya-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ndyaya-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ndyaya-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
