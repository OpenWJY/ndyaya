package com.ndyaya.framework.ai.core.factory;
...
import com.ndyaya.framework.ai.config.NdyayaAiAutoConfiguration;
import com.ndyaya.framework.ai.config.NdyayaAiProperties;
...
import com.ndyaya.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            NdyayaAiProperties.MidjourneyProperties properties = SpringUtil.getBean(NdyayaAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link NdyayaAiAutoConfiguration#deepSeekChatModel(NdyayaAiProperties)}
     */
    ...
    /**
     * 可参考 {@link NdyayaAiAutoConfiguration#xingHuoChatClient(NdyayaAiProperties)}
     */
