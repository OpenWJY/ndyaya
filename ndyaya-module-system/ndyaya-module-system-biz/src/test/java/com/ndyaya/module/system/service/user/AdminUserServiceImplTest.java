package com.ndyaya.module.system.service.user;
...
import com.ndyaya.framework.common.util.collection.ArrayUtils;
import com.ndyaya.framework.common.util.collection.CollectionUtils;
import com.ndyaya.framework.test.core.ut.BaseDbUnitTest;
import com.ndyaya.module.infra.api.config.ConfigApi;
import com.ndyaya.module.infra.api.file.FileApi;
import com.ndyaya.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.ndyaya.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.ndyaya.module.system.controller.admin.user.vo.user.*;
import com.ndyaya.module.system.dal.dataobject.dept.DeptDO;
import com.ndyaya.module.system.dal.dataobject.dept.PostDO;
import com.ndyaya.module.system.dal.dataobject.dept.UserPostDO;
import com.ndyaya.module.system.dal.dataobject.tenant.TenantDO;
import com.ndyaya.module.system.dal.dataobject.user.AdminUserDO;
import com.ndyaya.module.system.dal.mysql.dept.UserPostMapper;
import com.ndyaya.module.system.dal.mysql.user.AdminUserMapper;
import com.ndyaya.module.system.enums.common.SexEnum;
import com.ndyaya.module.system.service.dept.DeptService;
import com.ndyaya.module.system.service.dept.PostService;
import com.ndyaya.module.system.service.permission.PermissionService;
import com.ndyaya.module.system.service.tenant.TenantService;
...
import static com.ndyaya.framework.common.util.collection.SetUtils.asSet;
import static com.ndyaya.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.ndyaya.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.ndyaya.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.ndyaya.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.ndyaya.framework.test.core.util.AssertUtils.assertServiceException;
import static com.ndyaya.framework.test.core.util.RandomUtils.*;
import static com.ndyaya.module.system.enums.ErrorCodeConstants.*;
import static com.ndyaya.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("ndyayayuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ndyayayuanma");
        ...
        assertEquals("ndyayayuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("ndyayayuanma"))).thenReturn("java");
