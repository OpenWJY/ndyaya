...
import com.ndyaya.framework.common.util.cache.CacheUtils;
import com.ndyaya.framework.common.util.http.HttpUtils;
import com.ndyaya.framework.common.util.object.BeanUtils;
import com.ndyaya.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.ndyaya.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.ndyaya.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.ndyaya.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.ndyaya.module.system.dal.dataobject.social.SocialClientDO;
import com.ndyaya.module.system.dal.mysql.social.SocialClientMapper;
import com.ndyaya.module.system.dal.redis.RedisKeyConstants;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${ndyaya.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${ndyaya.wxa-subscribe-message.miniprogram-state:formal}")
