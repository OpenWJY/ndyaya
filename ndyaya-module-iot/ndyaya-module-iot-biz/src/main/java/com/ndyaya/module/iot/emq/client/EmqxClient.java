package com.ndyaya.module.iot.emq.client;

import com.ndyaya.module.iot.emq.callback.EmqxCallback;
import com.ndyaya.module.iot.emq.config.MqttConfig;
...
public class EmqxClient {
    ...
    private void createMqttClient() {
        try {
            mqttClient = new MqttClient(mqttConfig.getHostUrl(), "ndyaya" + mqttConfig.getClientId(), new MemoryPersistence());
