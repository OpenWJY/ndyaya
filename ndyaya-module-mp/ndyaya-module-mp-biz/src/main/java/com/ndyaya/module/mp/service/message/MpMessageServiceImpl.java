package com.ndyaya.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.ndyaya.framework.common.pojo.PageResult;
import com.ndyaya.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.ndyaya.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.ndyaya.module.mp.convert.message.MpMessageConvert;
import com.ndyaya.module.mp.dal.dataobject.account.MpAccountDO;
import com.ndyaya.module.mp.dal.dataobject.message.MpMessageDO;
import com.ndyaya.module.mp.dal.dataobject.user.MpUserDO;
import com.ndyaya.module.mp.dal.mysql.message.MpMessageMapper;
import com.ndyaya.module.mp.enums.message.MpMessageSendFromEnum;
import com.ndyaya.module.mp.framework.mp.core.MpServiceFactory;
import com.ndyaya.module.mp.framework.mp.core.util.MpUtils;
import com.ndyaya.module.mp.service.account.MpAccountService;
import com.ndyaya.module.mp.service.material.MpMaterialService;
import com.ndyaya.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.ndyaya.module.mp.service.user.MpUserService;
...
import static com.ndyaya.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
