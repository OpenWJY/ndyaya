package com.ndyaya.module.mp.service.account;
...
import com.ndyaya.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.ndyaya.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.ndyaya.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.ndyaya.module.mp.convert.account.MpAccountConvert;
import com.ndyaya.module.mp.dal.dataobject.account.MpAccountDO;
import com.ndyaya.module.mp.dal.mysql.account.MpAccountMapper;
import com.ndyaya.module.mp.enums.ErrorCodeConstants;
...
import static com.ndyaya.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 ndyaya-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
