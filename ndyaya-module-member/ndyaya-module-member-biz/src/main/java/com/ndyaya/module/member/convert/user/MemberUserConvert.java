package com.ndyaya.module.member.convert.user;

import com.ndyaya.framework.common.pojo.PageResult;
import com.ndyaya.module.member.api.user.dto.MemberUserRespDTO;
import com.ndyaya.module.member.controller.admin.user.vo.MemberUserRespVO;
import com.ndyaya.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import com.ndyaya.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
import com.ndyaya.module.member.convert.address.AddressConvert;
